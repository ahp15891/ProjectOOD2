...
namespace XmlProcessing
{
  ...
  public:
	...
	virtual std::vector<std::shared_ptr<AbstractXmlElement>> *return_children(){ return NULL; }
	virtual std::vector<std::pair<std::string, std::string>> *return_attribute(){ return NULL; }
  ...
  public:
	...
	DocElement(DocElement&& elem) : children_(std::move(elem.children_)){}
	DocElement& operator=(DocElement && elem){ children_ = std::move(elem.children_); return *this; }
	virtual std::vector<std::shared_ptr<AbstractXmlElement> > *return_children(){ return &children_; }
	virtual bool addChild(std::shared_ptr<AbstractXmlElement> pChild);
    virtual bool removeChild(std::shared_ptr<AbstractXmlElement> pChild);
  ...
  public:
	...
	TextElement(TextElement &&text) :text_(std::move(text.text_)){}
	TextElement& operator=(TextElement&& text){ text_ = std::move(text.text_); return *this; }
  ...
  public:
	...
	TaggedElement(TaggedElement &&tag) : tag_(std::move(tag.tag_)), children_(std::move(tag.children_)), attribs_(std::move(tag.attribs_)){}
	TaggedElement& operator= (TaggedElement &&tag);
    virtual bool addChild(std::shared_ptr<AbstractXmlElement> pChild);
    virtual bool removeChild(std::shared_ptr<AbstractXmlElement> pChild);
    ...
    virtual bool removeAttrib(const std::string& name);
	virtual std::vector<std::shared_ptr<AbstractXmlElement>> *return_children(){ return &children_; }
	virtual std::vector<std::pair<std::string, std::string>>*return_attribute(){ return &attribs_; }
	virtual bool type(){ return true; }
	virtual std::string value();
    virtual std::string toString();
  private:
    std::string tag_;
  ...
  public:
	...
	CommentElement(CommentElement &&comm) :commentText_(std::move(comm.commentText_)){}
    virtual ~CommentElement() {}
	CommentElement& operator=(CommentElement &&comm){ commentText_ = std::move(comm.commentText_); return *this; }
    CommentElement& operator=(const CommentElement& ce) = delete;
    virtual std::string value() { return commentText_; }
    virtual std::string toString() { return "Comment Element!!!  to be defined"; }
  private:
  ...
  public:
	...
	ProcInstrElement(ProcInstrElement&& proc) :type_(std::move(proc.type_)), attribs_(std::move(proc.attribs_)){}
	ProcInstrElement& operator=(ProcInstrElement&& proc){ type_ = std::move(proc.type_); attribs_ = std::move(proc.attribs_); return *this; }
	virtual std::vector<std::pair<std::string, std::string>>*return_attribute(){ return &attribs_; }
    virtual bool addAttrib(const std::string& name, const std::string& value);
    virtual bool removeAttrib(const std::string& name);
    virtual std::string value() { return type_; }
    virtual std::string toString() { return "ProcInstr Element!!!!"; }
	virtual bool type(){ return true; };
  private:
    std::vector<std::pair<std::string, std::string>> attribs_;
